...
const Contact = () => {
  useDocTitle("Northteck - Simplifying Tech Solutions for Success");
              ...
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">
                    Flat 6, Block 6, Pankshin Close, Off Emeka Anyaoku Street,
                    Garki, FCT, Abuja, Nigeria
                  </p>
                  <p className="text-gray-400">
                    10175 fortune Pkwy, Unit 1103-116, Jacksonville FLORIDA
                    32256, United States
                  </p>
                </div>
              </div>
